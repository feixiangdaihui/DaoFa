...
### 五行造化功
被动:
1. 按照元素相生顺序使用法宝、法术、符箓有一定概率进入元素拟态

轻击：施法以减少所有五行法术的冷却
重击：按五行相生顺序使用法术后解锁：飞上天空，轮流用五行法球轰炸。
...
### 金钟罩
点按：
1. 开启金钟罩，防御伤害，在恰当时机打开可以起到振刀的效果，使用时角色无法移动
2. 关闭金钟罩
...
### 千锋破岳剑
召唤12柄金灵气剑悬于头顶，每柄剑自动索敌造成80%攻击力伤害，造成破甲

### 五行戮神指
按金→水→木→火→土顺序释放法术或法宝后激活
五色神光贯穿目标
...
召唤火鸟直线冲击，接触目标产生扇形火焰溅射

### 不动明王
生成金钟罩抵挡3次攻击，破碎时反弹50%伤害
